...
### Function to Load Fashion Cats vs Dogs Dataset
"""
...
generator_model = load_model('generator_flowers_dynamic_e_10000.h5')
...
def save_plot(x_fake, X_real, qr_codes, epoch, n):
    ...
    for i in range(n):  # Loop through rows
        ...
        #img_file = 'resized_full_images_95_5/'+str(epoch)+'_'+str(i)+'.png'
    ...
    filename = 'generator_test_cats.png'
